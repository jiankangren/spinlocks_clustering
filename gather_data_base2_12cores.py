...
util=0.75
num_requests = 128
num_resources_list = [1, 3, 5, 7, 9, 11, 13, 15]
...
def gather_data():
    for num_res in num_resources_list:
        ...
        folder_path = 'ecrts_data_base/varying_num_requests/core='+str(num_cores)+'util='+str(util)+'resources='+str(num_res)+'requests='+str(num_requests)+'type='+cs_type
        #print folder_path
        ...
        print "#resources: ", num_requests, "Number of valid task sets: ", num_valid_tasksets
        results_analysis_fifo[num_res] = float(analysis_fifo_count)/num_valid_tasksets
        results_analysis_prio[num_res] = float(analysis_prio_count)/num_valid_tasksets
        results_exper_fifo[num_res] = float(exper_fifo_count)/num_valid_tasksets
        results_exper_prio[num_res] = float(exper_prio_count)/num_valid_tasksets
...
def gather_analysis_data():
    for num_requests in num_requests_list:
        ...
        folder_path = 'ecrts_data_base/core='+str(num_cores)+'util='+str(util)+'resources='+str(num_resources)+'requests='+str(num_requests)+'type='+cs_type
        #print folder_path
