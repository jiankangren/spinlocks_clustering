...
int main(int argc, char *argv[])
{
	...
	const std::string barrier_name = "RT_GOMP_CLUSTERING_BARRIER_3";

	// Name of the shared memory segment contains lock objects
	const std::string locks_name = "RT_GOMP_CLUSTERING_SPINLOCKS_3";

    // Name of the shared memory region contains statistics data
    const std::string stat_name = "RT_GOMP_CLUSTERING_STAT_3";
